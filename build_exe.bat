...
if exist installer\CombinePDFsInstaller_2.1.0.exe (
    powershell -NoProfile -ExecutionPolicy Bypass -File compute_hash.ps1 -InstallerPath "installer\CombinePDFsInstaller_2.1.0.exe"
) else (
