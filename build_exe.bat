...
if exist installer\CombinePDFsInstaller_2.1.1.exe (
    powershell -NoProfile -ExecutionPolicy Bypass -File compute_hash.ps1 -InstallerPath "installer\CombinePDFsInstaller_2.1.1.exe"
) else (
